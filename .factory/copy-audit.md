...
| At risk | 2 | — |
| Claude Code · Max seat | 4 | — |
| 17 sessions left · reset in 6 days | 7 | — |
| Approved fallback: Codex Team | 4 | — |
| How it works | 3 | — |
| Turn vendor readings into a team plan | 7 | — |
| Record each source | 3 | — |
| Add a vendor limit, current use, reset date, and daily pace. | 10 | — |
| Set approved fallbacks | 3 | — |
...
| --- | --- |
| A paid vendor capacity allocation | source |
| Remaining usable interactions | sessions |
| Allowed tool when a source is low | fallback |
| Usage horizon calculation | forecast |
| Cost assignment | project spend |
| Non-persistent sample workspace | demo |
| Paid access state | team plan |
| User-entered boundary date | reset date |
